...
CREATE TABLE `face_verifications` (
    ...
    `uploaded_image_id` VARCHAR(255) NOT NULL,
    ...
    UNIQUE INDEX `face_verifications_uploaded_image_id_key`(`uploaded_image_id`),
    PRIMARY KEY (`id`)
...
-- AddForeignKey
ALTER TABLE `face_verifications` ADD CONSTRAINT `face_verifications_uploaded_image_id_fkey` FOREIGN KEY (`uploaded_image_id`) REFERENCES `medias`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
